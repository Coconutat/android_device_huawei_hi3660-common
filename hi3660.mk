...
# Init
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/configs/init/fstab.hi3660:$(TARGET_COPY_OUT_RAMDISK)/fstab.hi3660 \
    $(COMMON_PATH)/configs/init/fstab.hi3660:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.hi3660 \
    ...
    $(COMMON_PATH)/configs/init/init.hi3660.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.hi3660.rc \
    ...
    $(COMMON_PATH)/configs/init/init.recovery.hi3660.rc:$(TARGET_RECOVERY_OUT)/root/init.recovery.hi3660.rc \
